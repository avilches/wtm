...
Interactive TUI for navigating and operating git worktrees. Browse worktrees, run common git operations, and create new worktrees without leaving the picker.

## Requirements

- [`git`](https://git-scm.com)
- [`worktrunk`](https://worktrunk.dev) (`wt`) at `/opt/homebrew/bin/wt`
